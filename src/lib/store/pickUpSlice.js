...
export const pickUpSlice = process.env.NODE_ENV === 'development' ?
  (set) => ({
    ...initialState,
    ...
    }, undefined, 'pickUpState/clickMenu'),
    // 선택된 메뉴 담기
    ...
    }, undefined, 'pickUpState/pickUpSelectedMenu'),
    // 바로 메뉴 담기
    pickUpMenu: (menu) => set((state) => ({ pickUpState: { ...state.pickUpState, list: [...state.pickUpState.list, menu] } }), undefined, 'pickUpState/pickUpMenu'),
    // 메뉴 삭제
    ...
    }, undefined, 'pickUpState/removePickUpMenu'),
    // 팝업에서 메뉴 수량 변경
    ...
    }), undefined, 'pickUpState/changeSelectedMenuAmount'),
    ...
    }, undefined, 'pickUpState/changeMenuAmountInPickUpList'),
  }) :
  (set) => ({
    ...initialState,
  })